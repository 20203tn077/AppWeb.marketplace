...
public class CategoryService {
    ...
    public ResponseEntity<Message> findById(long id){
        ...
        return new ResponseEntity<>(new Message("No se encontró la categoria",true,null),
    ...
    public ResponseEntity<Message> save(Category category){
        ...
        if (existCategory.isPresent()){
            return new ResponseEntity<>(new Message("La categoria ya existe",true,null),HttpStatus
                    .BAD_REQUEST);
        }
